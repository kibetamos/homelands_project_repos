...
function Register() {
  ...
  const submitForm = (e) => {
    ...
    setLoading(true);
    axios.post(Variables.apiURL + 'api/v1/auth/register/', submitPayload, { headers: headers })
      .then(response => {
                    ...
                    <div className="col-xl-12">
                      <div className="auth-form">
                        ...
                        <form id="registerAccountForm" onSubmit={submitForm}>
                          ...
                          <div className="form-group">
                            <label className="mb-1 text-primary"><strong>First Name</strong></label>
                          ...
                          <div class="custom-control custom-checkbox mb-3">
                            ...
                            <label class="pl-1" for="TermsConfirm">I have read the <a className='text-blue' href='Bulk_SMS_Agreement-UjumbePap.pdf'>terms and conditions</a> and I accept them.</label>
                          </div>
